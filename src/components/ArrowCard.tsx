...
export default function ArrowCard({ entry, pill }: Props) {
  const href = "permalink" in entry.data ? entry.data.permalink : `/${entry.collection}/${entry.slug}`
  const summary = "description" in entry.data ? entry.data.description : entry.data.summary
