var locations = [
    { lat: 40.7128, lng: -74.006, title: "New York, USA" },
    ...
    { lat: 50.0647, lng: 19.945, title: "Krakow, Poland" },
    { lat: 48.2082, lng: 16.3738, title: "Vienna, Austria" },
    { lat: 51.5074, lng: -0.1278, title: "London, UK" },
    { lat: 48.1351, lng: 11.582, title: "Munich, Germany" },
    ...
    { lat: 25.033, lng: 121.5654, title: "Taipei, Taiwan" },
    { lat: 13.7563, lng: 100.5018, title: "Bangkok, Thailand" },
    { lat: 47.8095, lng: 13.055, title: "Salzburg, Austria" },
    ...
    { lat: 32.7767, lng: -96.797, title: "Dallas, USA" },
    { lat: 36.1699, lng: -115.1398, title: "Las Vegas, USA" },
    { lat: 45.5051, lng: -122.675, title: "Portland, USA" },
    ...
    { lat: 43.65107, lng: -79.347015, title: "Toronto, Canada" },
    ...
    { lat: 38.0498, lng: -84.497, title: "Lexington, USA" },
    { lat: 42.4906, lng: -71.276, title: "Bedford, USA" },
    ...
    { lat: 42.0987, lng: -75.918, title: "Binghamton, USA" },
    ...
    { lat: 40.7934, lng: -77.86, title: "State College, USA" },
    { lat: 41.824, lng: -71.4128, title: "Providence, USA" },
    ...
    { lat: 33.749, lng: -84.388, title: "Atlanta, USA" },
    ...
    { lat: -34.471, lng: -57.8447, title: "Colonia Del Sacramento, Uruguay" },
    { lat: -34.6037, lng: -58.3816, title: "Buenos Aires, Argentina" },
    { lat: 37.5665, lng: 126.978, title: "Seoul, South Korea" },
